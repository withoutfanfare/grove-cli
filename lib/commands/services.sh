...
# svc_ensure_tool_path — Append Homebrew bin dirs to PATH when missing.
...
# and every daemon check would falsely report Not running. Appending (not
# prepending) preserves any user-chosen tool versions already on PATH.
